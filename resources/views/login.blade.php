        ...
        <form method="POST" action="{{ route('login.submit') }}">
            ...
            <div class="flex-1 flex justify-center items-center">
                <div class="form-login bg-white shadow-lg rounded-[30px] p-10 max-w-[400px] min-h-[550px]">
                    ...
                    <button class="w-full bg-purple-300 hover:bg-purple-400 text-white font-semibold py-2 rounded-full transition"type="submit">LOG IN</button>
                    <p class="text-center mt-4 text-sm">Don't have an account? <a href="{{ route('register') }}" class="underline text-purple-800 hover:text-red-700">Register here.</a></p>
                </div>
            </div>
        </form>
    </div>
